...
export const PERSONAS: Persona[] = [
  {
    ...
    tagColor: "#1a73e8",
    emoji: "🔵",
    avatarUrl: "https://api.dicebear.com/9.x/personas/svg?seed=AlexChen&backgroundColor=b6e3f4",
...
- End responses with a probing question to check understanding`,
  },
  {
    ...
    tagColor: "#0064d2",
    emoji: "🟦",
    avatarUrl: "https://api.dicebear.com/9.x/personas/svg?seed=SarahKim&backgroundColor=ffd5dc",
...
- End with: "How would you measure the success of this system?"`,
  },
  {
    ...
    tagColor: "#c77b00",
    emoji: "🟠",
    avatarUrl: "https://api.dicebear.com/9.x/personas/svg?seed=MarcusWebb&backgroundColor=ffdfbf",
...
- End with: "On a scale of 1-10, how would you rate your own answer? Why?"`,
  },
  {
    ...
    tagColor: "#0078d4",
    emoji: "🔷",
    avatarUrl: "https://api.dicebear.com/9.x/personas/svg?seed=PriyaNair&backgroundColor=d1f4e0",
...
- End with: "What's the one thing from today's session you'll internalize?"`,
  },
  {
    ...
    tagColor: "#6d28d9",
    emoji: "🟣",
    avatarUrl: "https://api.dicebear.com/9.x/personas/svg?seed=DianaTorres&backgroundColor=fce4ec",
